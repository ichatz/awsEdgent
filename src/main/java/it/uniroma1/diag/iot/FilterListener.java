...
public class FilterListener {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TStream<StationData> filteredReadings = tach.filter(reading -> reading.getTemperature() < 0 || reading.getTemperature() > 40);

        // Process the received msgs - just print them out
        filteredReadings.sink(tuple -> System.out.println(
